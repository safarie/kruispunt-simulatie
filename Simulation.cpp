...
void Simulation::initRoutes()
{
	...
	routeIn0.addSection(new Straight(glm::vec3(-71.75f, -80.0f, 0.0f), -90.0f, 40.0f));
	routeIn0.addSection(new TrafficLight(glm::vec3(-71.75f, -40.0f, 0.0f), -90, 2.0f, 0, &trafficLights)); // A1-1
	routeIn0.addSection(new Straight(glm::vec3(-71.75f, -38.0f, 0.0f), -90.0f, 8.0f));
	// trans
	routes.push_back(routeIn0);

	Route routeIn1(1, &models);
	routeIn1.addSection(new Straight(glm::vec3(-75.25f, -80.0f, 0.0f), -90.0f, 40.0f));
	routeIn1.addSection(new TrafficLight(glm::vec3(-75.25f, -40.0f, 0.0f), -90, 2.0f, 1, &trafficLights)); // A1-2
	routeIn1.addSection(new Straight(glm::vec3(-75.25f, -38.0f, 0.0f), -90.0f, 8.0f));
	// trans
	routes.push_back(routeIn1);

	Route routeIn2(2, &models);
	routeIn2.addSection(new Straight(glm::vec3(-78.75f, -80.0f, 0.0f), -90.0f, 40.0f));
	routeIn2.addSection(new TrafficLight(glm::vec3(-78.75f, -40.0f, 0.0f), -90, 2.0f, 2, &trafficLights)); // A1-3
	routeIn2.addSection(new Straight(glm::vec3(-78.75f, -38.0f, 0.0f), -90, 29.0f));
	routeIn2.addSection(new Corner(glm::vec3(-78.75f, -9.0f, 0.0f), -90, 23.25f, 90));
	//trans
	routes.push_back(routeIn2);

	Route routeIn3(3, &models);
	routeIn3.addSection(new Straight(glm::vec3(-82.25f, -80.0f, 0.0f), -90.0f, 40.0f));
	routeIn3.addSection(new TrafficLight(glm::vec3(-82.25f, -40.0f, 0.0f), -90, 2.0f, 3, &trafficLights)); // B1-1
	routeIn3.addSection(new End(glm::vec3(0.0f, 0.0f, -10.0f), 0));
	routes.push_back(routeIn3);

	Route routeIn4(4, &models);
	routeIn4.addSection(new Straight(glm::vec3(-150.0f, -21.25f, 0.0f), -180, 38.0f));
	routeIn4.addSection(new TrafficLight(glm::vec3(-112.0f, -21.25f, 0.0f), -180, 2.0f, 11, &trafficLights)); // A2-1
	routeIn4.addSection(new Straight(glm::vec3(-110.0f, -21.25f, 0.0f), -180, 8.0f));
	routeIn4.addSection(new Corner(glm::vec3(-102.0f, -21.25f, 0.0f), -180, 8.75f, -90));
	routes.push_back(routeIn4);

	Route routeIn5(5, &models);
	routeIn5.addSection(new Straight(glm::vec3(-150.0f, -17.75f, 0.0f), -180, 38.0f));
	routeIn5.addSection(new TrafficLight(glm::vec3(-112.0f, -17.75f, 0.0f), -180, 2.0f, 12, &trafficLights)); // A2-2
	routeIn5.addSection(new Straight(glm::vec3(-110.0f, -17.75f, 0.0f), -180, 8.0f));
	routeIn5.addSection(new Corner(glm::vec3(-102.0f, -17.75f, 0.0f), -180, 12.25f, -90));
	routes.push_back(routeIn5);

	Route routeIn6(6, &models);
	routeIn6.addSection(new Straight(glm::vec3(-150.0f, -14.25f, 0.0f), -180, 38.0f));
	routeIn6.addSection(new TrafficLight(glm::vec3(-112.0f, -14.25f, 0.0f), -180, 2.0f, 13, &trafficLights)); // A2-3
	routeIn6.addSection(new Straight(glm::vec3(-110.0f, -14.25f, 0.0f), -180, 22.0f));
	routes.push_back(routeIn6);

	Route routeIn7(7, &models);
	routeIn7.addSection(new Straight(glm::vec3(-150.0f, -10.75f, 0.0f), -180, 38.0f));
	routeIn7.addSection(new TrafficLight(glm::vec3(-112.0f, -10.75f, 0.0f), -180, 2.0f, 14, &trafficLights)); // A2-4
	routeIn7.addSection(new Straight(glm::vec3(-110.0f, -10.75f, 0.0f), -180, 22.0f));
	routes.push_back(routeIn7);

	Route routeIn8(8, &models);
	routeIn8.addSection(new Straight(glm::vec3(82.25f, 80.0f, 0.0f), 90.0f, 36.0f));
	routeIn8.addSection(new TrafficLight(glm::vec3(82.25f, 44.0f, 0.0f), 90, 2.0f, 25, &trafficLights)); // A4-1
	routeIn8.addSection(new Straight(glm::vec3(82.25f, 42.0f, 0.0f), 90, 33.0f));
	routeIn8.addSection(new Corner(glm::vec3(82.25f, 9.0f, 0.0f), 90, 19.75f, 90));
	routes.push_back(routeIn8);

	Route routeIn9(9, &models);
	routeIn9.addSection(new Straight(glm::vec3(78.75f, 80.0f, 0.0f), 90.0f, 36.0f));
	routeIn9.addSection(new TrafficLight(glm::vec3(78.75f, 44.0f, 0.0f), 90, 2.0f, 26, &trafficLights)); // A4-2
	routeIn9.addSection(new Straight(glm::vec3(78.75f, 42.0f, 0.0f), 90, 33.0f));
	routeIn9.addSection(new Corner(glm::vec3(78.75f, 9.0f, 0.0f), 90, 23.25f, 90));
	routes.push_back(routeIn9);

	Route routeIn10(10, &models);
	routeIn10.addSection(new Straight(glm::vec3(75.25f, 80.0f, 0.0f), 90.0f, 36.0f));
	routeIn10.addSection(new TrafficLight(glm::vec3(75.25f, 44.0f, 0.0f), 90, 2.0f, 27, &trafficLights)); // A4-3
	routeIn10.addSection(new Straight(glm::vec3(75.25f, 42.0f, 0.0f), 90.0f, 12.0f));
	routes.push_back(routeIn10);

	Route routeIn11(11, &models);
	routeIn11.addSection(new Straight(glm::vec3(71.75f, 80.0f, 0.0f), 90.0f, 36.0f));
	routeIn11.addSection(new TrafficLight(glm::vec3(71.75f, 44.0f, 0.0f), 90, 2.0f, 28, &trafficLights)); // A4-4
	routeIn11.addSection(new Straight(glm::vec3(71.75f, 42.0f, 0.0f), 90.0f, 12.0f));
	routes.push_back(routeIn11);

	Route routeIn12(12, &models);
	routeIn12.addSection(new Straight(glm::vec3(68.25f, 80.0f, 0.0f), 90.0f, 34.0f));
	routeIn12.addSection(new TrafficLight(glm::vec3(68.25f, 46.0f, 0.0f), 90, 2.0f, 29, &trafficLights)); // B4-1
	routeIn12.addSection(new End(glm::vec3(0.0f, 0.0f, -10.0f), 0));
	routes.push_back(routeIn12);

	Route routeIn13(13, &models);
	routeIn13.addSection(new Straight(glm::vec3(150.0f, 10.75f, 0.0f), 0, 38.0f));
	routeIn13.addSection(new TrafficLight(glm::vec3(112.0f, 10.75f, 0.0f), 0, 2.0f, 36, &trafficLights)); // A5-1
	routeIn13.addSection(new Straight(glm::vec3(110.0f, 10.75f, 0.0f), 0, 22.0f));
	routes.push_back(routeIn13);

	Route routeIn14(14, &models);
	routeIn14.addSection(new Straight(glm::vec3(150.0f, 14.25f, 0.0f), 0, 38.0f));
	routeIn14.addSection(new TrafficLight(glm::vec3(112.0f, 14.25f, 0.0f), 0, 2.0f, 37, &trafficLights)); // A5-2
	routeIn14.addSection(new Straight(glm::vec3(110.0f, 14.25f, 0.0f), 0, 22.0f));
	routes.push_back(routeIn14);

	Route routeIn15(15, &models);
	routeIn15.addSection(new Straight(glm::vec3(150.0f, 17.75f, 0.0f), 0, 38.0f));
	routeIn15.addSection(new TrafficLight(glm::vec3(112.0f, 17.75f, 0.0f), 0, 2.0f, 38, &trafficLights)); // A5-3
	routeIn15.addSection(new Straight(glm::vec3(110.0f, 17.75f, 0.0f), 0, 8.0f));
	...
	routeIn16.addSection(new Straight(glm::vec3(150.0f, 21.25f, 0.0f), 0, 38.0f));
	routeIn16.addSection(new TrafficLight(glm::vec3(112.0f, 21.25f, 0.0f), 0, 2.0f, 39, &trafficLights)); // A5-4
	routeIn16.addSection(new Straight(glm::vec3(110.0f, 21.25f, 0.0f), 0, 8.0f));
	...
	routeCon17.addSection(new Straight(glm::vec3(-60.0f, -14.25f, 0.0f), -180, 127.0f));
	routeCon17.addSection(new TrafficLight(glm::vec3(67.0f, -14.25f, 0.0f), -180, 2.0f, 46, &trafficLights)); // A6-1
	routeCon17.addSection(new Straight(glm::vec3(69.0f, -14.25f, 0.0f), -180, 33.0f));
	// trans
	routes.push_back(routeCon17);

	Route routeCon18(18, &models);
	routeCon18.addSection(new Straight(glm::vec3(-60.0f, -10.75f, 0.0f), -180, 127.0f));
	routeCon18.addSection(new TrafficLight(glm::vec3(67.0f, -10.75f, 0.0f), -180, 2.0f, 47, &trafficLights)); // A6-2
	routeCon18.addSection(new Straight(glm::vec3(69.0f, -10.75f, 0.0f), -180, 33.0f));
	// trans
	routes.push_back(routeCon18);

	Route routeCon19(19, &models);
	routeCon19.addSection(new Straight(glm::vec3(-60.0f, -7.25f, 0.0f), -180, 127.0f));
	routeCon19.addSection(new TrafficLight(glm::vec3(67.0f, -7.25f, 0.0f), -180, 2.0f, 48, &trafficLights)); // A6-3
	routeCon19.addSection(new Straight(glm::vec3(69.0f, -7.25f, 0.0f), -180, 8.0f));
	...
	routeCon20.addSection(new Straight(glm::vec3(-60.0f, -3.75f, 0.0f), -180, 127.0f));
	routeCon20.addSection(new TrafficLight(glm::vec3(67.0f, -3.75f, 0.0f), -180, 2.0f, 49, &trafficLights)); // A6-4
	routeCon20.addSection(new Straight(glm::vec3(69.0f, -3.75f, 0.0f), -180, 8.0f));
	...
	routeCon21.addSection(new Straight(glm::vec3(60.0f, 3.75f, 0.0f), 0, 127.0f));
	routeCon21.addSection(new TrafficLight(glm::vec3(-67.0f, 3.75f, 0.0f), 0, 2.0f, 21, &trafficLights)); // A3-1
	routeCon21.addSection(new Straight(glm::vec3(-69.0f, 3.75f, 0.0f), 0, 8.0f));
	...
	routeCon22.addSection(new Straight(glm::vec3(60.0f, 7.25f, 0.0f), 0, 127.0f));
	routeCon22.addSection(new TrafficLight(glm::vec3(-67.0f, 7.25f, 0.0f), 0, 2.0f, 22, &trafficLights)); // A3-2
	routeCon22.addSection(new Straight(glm::vec3(-69.0f, 7.25f, 0.0f), 0, 8.0f));
	...
	routeCon23.addSection(new Straight(glm::vec3(60.0f, 10.75f, 0.0f), 0, 127.0f));
	routeCon23.addSection(new TrafficLight(glm::vec3(-67.0f, 10.75f, 0.0f), 0, 2.0f, 23, &trafficLights)); // A3-3
	routeCon23.addSection(new Straight(glm::vec3(-69.0f, 10.75f, 0.0f), 0, 33.0f));
	// trans
	routes.push_back(routeCon23);

	Route routeCon24(24, &models);
	routeCon24.addSection(new Straight(glm::vec3(60.0f, 14.25f, 0.0f), 0, 127.0f));
	routeCon24.addSection(new TrafficLight(glm::vec3(-67.0f, 14.25f, 0.0f), 0, 2.0f, 24, &trafficLights)); // A3-4
	routeCon24.addSection(new Straight(glm::vec3(-69.0f, 14.25f, 0.0f), 0, 33.0f));
	// trans
